                        ...
                        <table class="w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Ano da publicação</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($livros as $livro)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $livro->ano_publicação}}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-4 whitespace-nowrap text-center text-gray-500 dark:text-gray-300">Nenhum livro encontrado.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
